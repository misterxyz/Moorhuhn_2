...
class MoorhuhnSpiel(object):
    def __init__(self):						#Kombiniert Elemente des Moorhuhn Spiels.
        ...
        if Level <=6:
            bild.screen.bgpic("ostsee.png")                     #'bgpic' ist eine Methode, um ein Hintergrundbild zu installieren
        elif Level >=7:
            bild.screen.bgpic("bauernhof.png")
        ...
        #####################################################
        self.huehner_rechts = [Huhn("huhn03.gif", self),    #
    ...
    def spiel(self):
        ...
        for huhn in self.huehner_links:
            huhn.start_links()
        #####################################
        for huhn in self.huehner_rechts:    #
            huhn.start_rechts()             #
        #####################################
        while not self.gameover:
            ...
            #########################################################
            for huhn in self.huehner_rechts:                        #
                gameover = (gameover and huhn.ausdemspiel_rechts)   #
            #########################################################
            self.gameover = gameover            
        trefferrate = self.score/self.schuss   
        ...
        if trefferrate >= 0.8:
            self.klang(GUT)
        elif 0.5 <= trefferrate < 0.75:
            self.klang(APPLAUS)
            
        global Punkte
        Punkte=Level*trefferrate*(Strafpunkt_links_rechts*Strafpunkt_rechts_links)**-1
