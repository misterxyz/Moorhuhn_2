...
screen=pygame.set_mode((850,250))                                           #ein leeres (noch farbloses) Feld der Größe 800 x 250 wird erstellt
    ...
    def update(self):
        if not self.done:                                       #sofern die Aufgabe, den Text zu zeigen, noch nicht vollständig abgeschlossen ist
            try:
                ...
                subprocess.open("moorhuhn_2.py", shell is True)   #rufe das richtige Spiel auf
