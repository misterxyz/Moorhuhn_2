...
font=pygame.font(None, 38)                                                 #Schriftgröße des Textes


class DynamicText(object):
    def __init__(self, font, pos):
        self.font=font
        self.gen=text_generator(self.text)                     #Initialisierung, daß auf den Textgenerator zugegriffen wird
        self.pos=pos                                            #Initialisierung einer (Text-)Position

    def reset():                                            #fasst den Textgenerator (also Texterzeuger) und den Abschluss des Textzeigens zusammen
        self.done==False
        self.update
   
message=DynamicText(front, (65,120))                                       #Position des Textes im schwarzen Feld
