...
class Credits:
    def _init_(self, bildschirm, liste):
        self.bildschirm=bildschirm                          #hier wird ein Bildschirm initialisiert/festgelegt
        self.liste=liste                                    #die Liste ist die Nachricht
        self.schriftgroesse=50                                #hier wird die Schriftgröße festgelegt
        self.schriftfarbe=(255,255,255)                     #Schriftfarbe weiß
        self.Bildschirmmitte=self.bildschirm.height/2    #wo ist die Schrift anzusetzen (in der Mitte)
    ...
    def Bildschirmoberfläche(self):
        text=[]                                        #am Anfang ist das Array noch leer
...
while running:                              #diese Schleife ist immer wahr, weil running auf TRUE gesetzt wurde (s.o.) => Endlosschleife
    ...
    credit.update()                           #hier wird dafür gesorgt, daß der Text runterscrollt
